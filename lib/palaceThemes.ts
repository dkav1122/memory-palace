/**
 * Visual asset packs for each palace map theme. Geometry (path, terrain
 * height, waypoints) stays in lib/palace.ts so every theme keeps the same
 * deterministic route — only materials, scatter, landmarks, and atmosphere
 * change.
 */
